...
Color secondaryColor = const Color(0xff00A170);
Color tertiaryColor = const Color(0xff8D887D);
Color alertColor = const Color(0xffED6363);
Color priceColor = const Color(0xff2C96F1 );
Color backgraundColor1 = const Color(0xff252119);
Color backgraundColor2 = const Color(0xff322D25);
Color backgraundColor3 = const Color(0xff2F2A21);
Color backgraundColor4 = const Color(0xff353025);
