...
class ReservationChooseProductScreen extends StatefulWidget {
  static const routeName = '/choose-product-reservation';

  final String? type;
  const ReservationChooseProductScreen({ 
    Key? key,
    required this.type,
  }) : super(key: key);

  @override
  _ReservationChooseProductScreenState createState() => _ReservationChooseProductScreenState();
}

class _ReservationChooseProductScreenState extends State<ReservationChooseProductScreen> {
                          ...
                          children: [
                            IconButton(
                              ...
                              onPressed: () {
                                Navigator.pushNamed(
                                  context, 
                                  CustomerReservationCartScreen.routeName,
